...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 18 nov. 2020 à 13:27
...
CREATE TABLE IF NOT EXISTS `quizz` (
  ...
  `Rep2` varchar(250) NOT NULL,
  `Rep3` varchar(250) NOT NULL,
  `Rep4` int(1) NOT NULL,
  `Rep5` varchar(250) NOT NULL,
  `Rep6` varchar(250) NOT NULL,
  PRIMARY KEY (`idquizz`)
...
INSERT INTO `quizz` (`idquizz`, `namequizz`, `Rep1`, `Rep2`, `Rep3`, `Rep4`, `Rep5`, `Rep6`) VALUES
(1, 'Quizz1', 'Ronaldo', 'Real Madrid', 'Portugal', 2, 'Grèce', 'Eder');
